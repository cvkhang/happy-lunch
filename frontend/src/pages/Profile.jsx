          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            {isEditingProfile ? (
              ...
              <div className="border-t border-slate-100 p-5 space-y-3">
                ...
                <Link
                  to="/favorites"
                  className="w-full mt-2 py-2 px-4 bg-red-50 text-red-600 rounded-xl font-medium hover:bg-red-100 transition-all text-sm flex items-center justify-center gap-2"
                >
